...
export const Features = () => {
  ...
  return (
    <section id="diferenciais" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-[color:var(--color-outline-variant)] bg-[color:var(--color-surface-container-low)]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => (
            <div key={idx} className="p-8 rounded-lg border border-[color:var(--color-outline-variant)] bg-[color:var(--color-background)] hover:border-[color:var(--color-primary)]/50 transition-colors">
              <div className="w-10 h-10 rounded bg-[color:var(--color-primary)]/10 flex items-center justify-center mb-6 text-[color:var(--color-primary)]">
