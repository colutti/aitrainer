...
export const HowItWorks = () => {
  ...
  return (
    <section id="como-funciona" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-[color:var(--color-outline-variant)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {steps.map((item, idx) => (
            <div key={idx} className="relative group">
              ...
              {idx < 2 && (
                <div className="hidden md:block absolute top-12 -right-6 text-[color:var(--color-outline-variant)]">
