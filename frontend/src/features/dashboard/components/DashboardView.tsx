    ...
    <div className="space-y-8 pb-20 pr-1" data-testid="dashboard-bento">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mt-4">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-[22px] bg-white/5 border border-white/10 p-3 flex items-center justify-center shadow-inner">
             <img src="/logo_icon.png" alt="Logo" className="w-full h-full object-contain" />
          </div>
          <div>
            <p className="text-zinc-500 font-bold tracking-[0.2em] uppercase text-[10px] mb-1">{t('dashboard.summary_subtitle')}</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className={cn("px-4 py-2 rounded-xl border text-[10px] font-black uppercase tracking-wider h-[46px] flex items-center gap-3 transition-colors", confidenceColor)}>
            <Activity size={18} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* PESO */}
        <PremiumCard className="p-6 md:p-8 h-72 flex flex-col group overflow-hidden relative">
        ...
        {/* GORDURA */}
        <PremiumCard data-testid="widget-fat" className="p-6 md:p-8 h-72 flex flex-col group overflow-hidden relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        {/* HUB METABÓLICO */}
        <PremiumCard data-testid="widget-metabolism" className="md:col-span-2 p-8 flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="relative z-10 flex justify-between items-start mb-8">
            ...
            <div className="text-right">
              ...
              <span className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-black text-white uppercase tracking-wider">
