...
class TestGetNutritionLogs:
    ...
    def test_get_nutrition_logs_sorts_descending(self, db):
        ...
        db.nutrition.collection.find.return_value.sort.assert_called_with(
    ...
    def test_get_nutrition_logs_respects_limit(self, db):
        ...
        db.nutrition.collection.find.return_value.sort.return_value.limit.assert_called_with(
            15
        )
...
class TestGetNutritionPaginated:
    ...
    def test_get_nutrition_paginated_calculates_skip_correctly(self, db):
        ...
        db.nutrition.collection.find.return_value.sort.return_value.skip.assert_called_with(
            20
        )
