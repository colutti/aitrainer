...
class TestGetWeightLogs:
    ...
    def test_get_weight_logs_returns_weight_log_objects(self, db):
        ...
        db.weight.collection.find.return_value.sort.return_value.limit.return_value = (
            mock_cursor
        )
    ...
    def test_get_weight_logs_respects_limit(self, db):
        ...
        db.weight.collection.find.return_value.sort.return_value.limit.assert_called_with(
            10
        )
    ...
    def test_get_weight_logs_sorts_descending(self, db):
        ...
        db.weight.collection.find.return_value.sort.assert_called_with(
    ...
    def test_get_weight_logs_filters_by_user_email(self, db):
        ...
        db.weight.collection.find.assert_called_with(
