...
class TestDatabaseWorkouts(unittest.TestCase):
    ...
    def test_get_workouts_paginated_query_construction(self):
        ...
        mock_cursor.__iter__.return_value = iter([
            {"_id": "1", "user_email": "test@test.com", "workout_type": "Legs", "exercises": [], "date": "2024-01-01"}
        ])
    ...
    def test_get_workout_types(self):
        ...
        self.mock_collection.distinct.assert_called_with("workout_type", {"user_email": "test@test.com"})
