"""Test T04: Inglês - "until summer 2026"."""
import json
import subprocess
import time
...
def test_english():
    """3 mensagens em inglês, build muscle, summer 2026."""
    _reset()
    time.sleep(2)
    token = _login()
    ...
    for msg in [
        "hello",
        "i want to build muscle, i can train monday, wednesday, friday for 60 minutes",
        "until summer 2026, no injuries or restrictions",
    ]:
        _send(token, msg)
        time.sleep(WAIT)
