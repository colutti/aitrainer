"""Test T08: Info espalhada - 4 mensagens (inglês)."""
import json
import subprocess
import time
...
def test_info_espalhada():
    """4 mensagens em inglês: goal, days, deadline+restrictions, duration
    separated across turns."""
    _reset()
    time.sleep(2)
    token = _login()
    ...
    for msg in [
        "hi there",
        "i want to build muscle, can train monday wednesday friday",
        "until summer, no injuries or restrictions",
