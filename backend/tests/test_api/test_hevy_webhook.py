...
def mock_user():
    return UserProfile(
        ...
        gender="Masculino", age=25, weight=70, height=175, goal="Gain Muscle", goal_type="gain",
...
async def test_process_webhook_async_logic():
    ...
    mock_service.fetch_workout_by_id.return_value = {"id": "workout-456", "title": "Chest Day"}
    mock_service.transform_to_workout_log.return_value = MagicMock()
    mock_service.workout_repository.collection.find_one.return_value = None
