...
def test_to_string_list():
    ...
    msgs = [
        ...
        ChatHistory(text="Hello", sender=Sender.TRAINER, timestamp="2024-01-01T10:01:00")
    ]
...
def test_format_with_trainer_context():
    ...
    msgs = [
        ChatHistory(text="Hi", sender=Sender.STUDENT, timestamp="2024-01-01T10:00:00"),
        ChatHistory(text="Hello", sender=Sender.TRAINER, timestamp="2024-01-01T10:01:00", trainer_type="atlas"),
        ChatHistory(text="Old Hello", sender=Sender.TRAINER, timestamp="2024-01-01T09:00:00", trainer_type="old_trainer")
    ]
...
def test_format_with_trainer_context_empty():
    ...
    assert ChatHistory.format_with_trainer_context([], "atlas") == "Nenhuma mensagem anterior."
