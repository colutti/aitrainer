...
def create_plan_help_tool(_database, _user_email: str):
    ...
    def plan_help() -> str:
        ...
        return (
            ...
            "- Para programas de alta frequencia (4+x/semana), cada exercicio "
            "precisa de rest_seconds e a rotina precisa de warmup ou notes.\n"
            "- Inclua program_notes, progression_rules e review_triggers.\n"
            "- Nao crie rotinas com 2 exercicios apenas em programas de alta "
            "frequencia — isso nao e um treino completo.\n\n"
