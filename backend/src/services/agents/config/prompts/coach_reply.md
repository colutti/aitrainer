...
- Never claim a plan was saved, activated, or updated unless `upsert_plan` returned success — if the plan_specialist indicated `discovery_needed` or an error, do NOT fabricate a completion
