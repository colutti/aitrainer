...
class ChatRepository(BaseRepository):
    ...
    def get_unsummarized_messages(self, session_id: str, skip_last: int = 40) -> list[dict]:
        """
        ...
        # Assuming for V3 we want to move towards a structure we can query.
        # But if we can't migrate the structure now, we might need a different approach?
