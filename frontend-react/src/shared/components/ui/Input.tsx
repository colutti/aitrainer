      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative group">
          ...
          <input
            type={type}
            className={cn(
              'flex h-11 w-full rounded-lg bg-dark-card border border-border px-3 py-2 text-sm transition-all focus:outline-none focus:ring-2 focus:ring-gradient-start/20 focus:border-gradient-start placeholder:text-text-tertiary disabled:cursor-not-allowed disabled:opacity-50',
              leftIcon && 'pl-10',
